...
int main(int argc, char **argv) {
  ...
  //******* Setting the Options  *******
  const char* map_img_filename = "/Users/andreas/robots/libraries/surveillance/graph_clear/bin/maps/ucm3.bmp";

  Config* robot_cfg = new Config; 
  char* cfg_filename = "../../surv_robot.cfg";
  robot_cfg->readFile(cfg_filename);
  float lower_thres;
