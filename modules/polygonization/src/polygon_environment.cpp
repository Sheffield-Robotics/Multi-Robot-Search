    ...
    Polygon_Environment::shortest_split_cost(int i, int j, int k, double& cost) 
{
    ...
    KERNEL::Point_2 v = point_on_k_from_i + (float(1)/float(2)) * vec;
    ...
    //get_shortest_path_to_special_v(i);
    //get_shortest_path_to_special_v(j);
